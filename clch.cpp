...
Apple Display P3 D65(0.9505, 1.0000, 1.08905)
	 0.51512    0.29198    0.15710
	 0.24120    0.69225    0.06657
	-0.00105    0.04189    0.78407

	 2.40400    -0.98991  -0.39763
	-0.84226     1.79885   0.01603
	 0.04822    -0.09743   1.27401
...
//RGB2XYZ(ColorMatchRGB)
double DisplayP3_D50[3][3] = {
	{ 0.51512,  0.29198,    0.15710},
	{ 0.24120,  0.69225,    0.06657},
	{-0.00105,  0.04189,    0.78407} };

double inv_DisplayP3_D50[3][3] = {
	{ 2.40400, -0.98991,   -0.39763},
	{-0.84226,  1.79885,    0.01603},
	{ 0.04822, -0.09743,    1.27401} };
/*
...
void CLCH::SetColorSpace(ColorSpace sig)
{
	...
	case CS_ColorDisplayP3:
		memcpy(m_RGB2XYZ, DisplayP3_D50, sizeof(double) * 9);
		memcpy(m_XYZ2RGB, inv_DisplayP3_D50, sizeof(double) * 9);
		break;
...
double DisplayP3_Gamma_Decode(double data)
{
	if (data <= 0.004045)
		...
		return pow((data * 0.9479 + 0.05214), 2.4);
}
